...
Table 1 of @shankar2025. For each outlier configuration, the mean parameter estimation RMSEs of each method is reported relative to the oracle benchmark method:
...
### ROAMS lambda selected {.tabset}

Mean-aggregated and raw value of the tuning parameter $\lambda$ selected by ROAMS when fitting models.
