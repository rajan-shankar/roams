...
Simulated data is generated using the `simulate_data_study1()` function. We set it to generate B = 300 data sets for each combination of sample size (100, 200, 500, 100) and outlier configuration (clean data, fixed distance, multi-level, cluster). Seed is set to 1303.
